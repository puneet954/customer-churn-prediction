...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            numerical_columns = ["MonthlyCharges","TotalCharges","tenure","SeniorCitizen"]
            categorical_columns = [
                "gender",
                "Partner",
                "Dependents",
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            # Drop identifier column, it carries no predictive signal
            ...
            # Encode target labels Yes/No -> 1/0 so metrics/models get numeric labels
